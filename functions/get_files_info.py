...
def get_files_info(working_directory, directory="."):
    ...
    target_path = os.path.normpath(os.path.abspath(os.path.join(working_directory, directory)))
    ...
    # Build string containing the directory contents
        ...
        try:
            ...
            directory_list = os.listdir(target_path)

            filepath_list = list(map(lambda x: os.path.abspath(os.path.join(target_path, x)) , directory_list))
